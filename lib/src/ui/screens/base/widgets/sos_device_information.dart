...
class DeviceSOSInformation extends StatefulWidget {
  final String deviceID;

  const DeviceSOSInformation({Key key, this.deviceID}) : super(key: key);
  @override
  _DeviceInformationState createState() => _DeviceInformationState();
}

class _DeviceInformationState extends State<DeviceSOSInformation> {
      ...
      listener: (context, state) {
        ...
        if (state is GraphqlLoadingState) {
          Dialogs.showLoadingDialog(context,
              message: 'loading device sos info...');
        }
      },
    );
  }
